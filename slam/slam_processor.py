...
from slam.keypoint_matching import build_pose_matrix, estimate_pose_from_essential_matrix, estimate_pose_from_matches, get_keypoint_pointcloud, get_matches
...
def process_frame(
    ...
    # Project keypoints to 3D , for checking stuff
    keypoint_pointcloud = get_keypoint_pointcloud(keypoints, depth_tensor.squeeze().numpy(), curr_pose.numpy(), intrinsics)
    orr_log_global_pointcloud(keypoint_pointcloud, entity_label="orb_keypoints")
